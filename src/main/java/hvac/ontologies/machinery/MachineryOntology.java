...
public class MachineryOntology extends Ontology {
    ...
    public static final String AIR_CONDITIONER_AIR_EXCHANGED_PER_SECOND = "coolingPower";
    ...
    public static final String VENTILATOR_AIR_EXCHANGED_PER_SECOND = "heatingPower";
    ...
    public static final String REPORT_MACHINERY_STATUS_MACHINERY_STATUS = "machineryStatus";
    ...
    private MachineryOntology() {
        ...
        try {
            ...
            cs.add(MACHINE_PARAMETER_MAX_VALUE, (PrimitiveSchema)getSchema(BasicOntology.FLOAT));
